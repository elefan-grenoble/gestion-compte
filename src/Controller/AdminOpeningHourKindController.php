...
class AdminOpeningHourKindController extends AbstractController
{
    ...
    public function listAction()
    {
        ...
        return $this->render('admin/openinghour/kind/list.html.twig', [
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin/openinghour/kind/new.html.twig', [
    ...
    public function editAction(Request $request, OpeningHourKind $openingHourKind)
    {
        ...
        return $this->render('admin/openinghour/kind/edit.html.twig', [
            'form' => $form->createView(),
    ...
    protected function getDeleteForm(OpeningHourKind $openingHourKind)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_openinghour_kind_delete', ['id' => $openingHourKind->getId()]))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
