...
class AppExtension extends AbstractExtension
{
    ...
    public function getFilters()
    {
        return [
            ...
            new TwigFilter('email_encode', [$this, 'encodeText']),
            new TwigFilter('priority_to_color', [$this, 'priority_to_color']),
            new TwigFilter('date_fr', [$this, 'date_fr']),
            new TwigFilter('date_fr_long', [$this, 'date_fr_long']),
            new TwigFilter('date_fr_full', [$this, 'date_fr_full']),
            new TwigFilter('date_fr_with_time', [$this, 'date_fr_with_time']),
            new TwigFilter('date_fr_long_with_time', [$this, 'date_fr_long_with_time']),
            new TwigFilter('date_fr_full_with_time', [$this, 'date_fr_full_with_time']),
            new TwigFilter('date_short', [$this, 'date_short']),
            new TwigFilter('date_time', [$this, 'date_time']),
            new TwigFilter('date_w3c', [$this, 'date_w3c']),
            new TwigFilter('time_short', [$this, 'time_short']),
            new TwigFilter('duration_from_minutes', [$this, 'duration_from_minutes']),
            new TwigFilter('qr', [$this, 'qr']),
            new TwigFilter('barcode', [$this, 'barcode']),
            new TwigFilter('vigenere_encode', [$this, 'vigenere_encode']),
            new TwigFilter('vigenere_decode', [$this, 'vigenere_decode']),
            new TwigFilter('recall_date', [$this, 'get_recall_date']),
            new TwigFilter('img', [$this, 'imgFilter']),
            new TwigFilter('payment_mode_devise', [$this, 'payment_mode_devise']),
            new TwigFilter('payment_mode', [$this, 'payment_mode']),
        ];
    }
