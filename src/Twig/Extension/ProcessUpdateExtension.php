...
class ProcessUpdateExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFilter('last_shift_date', [$this, 'last_shift_date']),
            new TwigFilter('updates_list_from_date', [$this, 'updates_list_from_date']),
            new TwigFilter('count_updates_list_from_date', [$this, 'count_updates_list_from_date']),
            new TwigFilter('w3c_to_date', [$this, 'w3c_to_date']),
        ];
    }
