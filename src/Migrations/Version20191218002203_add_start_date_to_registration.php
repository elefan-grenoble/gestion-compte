...
final class Version20191218002203_add_start_date_to_registration extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE ALGORITHM=TEMPTABLE VIEW view_abstract_registration AS (SELECT CONCAT(\'1_\',registration.id) as id,1 as type,registrar_id,created_at as date,date as start_date,amount,mode,CONCAT(LOWER(beneficiary.firstname),\' \',UPPER(beneficiary.lastname)) as beneficiary, registration.membership_id
       FROM registration
      ...
      (SELECT CONCAT(\'2_\',id) as id,2 as type,registrar_id,created_at as date,created_at as start_date,amount,mode,email as beneficiary, NULL as membership_id
