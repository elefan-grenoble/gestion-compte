...
final class Version20230503235634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE period_position_free_log (id INT AUTO_INCREMENT NOT NULL, period_position_id INT DEFAULT NULL, period_position_string LONGTEXT NOT NULL, beneficiary_id INT DEFAULT NULL, booked_time DATETIME DEFAULT NULL, created_by_id INT DEFAULT NULL, request_route VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_389B7C61A95DF5B1 (period_position_id), INDEX IDX_389B7C61ECCAAFA0 (beneficiary_id), INDEX IDX_389B7C61B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('ALTER TABLE period_position_free_log ADD CONSTRAINT FK_389B7C61A95DF5B1 FOREIGN KEY (period_position_id) REFERENCES period_position (id) ON DELETE SET NULL');
