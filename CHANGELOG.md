...
## [2.0.0](https://github.com/elefan-grenoble/gestion-compte/compare/v1.47.2...v2.0.0) (2026-09-04)
...
* **anonymization:** export de base de données anonymisée auto-vérifié ([#1257](https://github.com/elefan-grenoble/gestion-compte/issues/1257)) ([6b768fc](https://github.com/elefan-grenoble/gestion-compte/commit/6b768fc3fceecec8f8adf9d350754ecc33415a5e))
...
* Un paramètre pour pouvoir désactiver la copie du mail de réservation de créneau ([#1196](https://github.com/elefan-grenoble/gestion-compte/issues/1196)) ([e466201](https://github.com/elefan-grenoble/gestion-compte/commit/e466201a8e9ed96c4242dad4ae4f3e3243c37885))
...
* default-deny access_control terminal rule + api/oauth ordering ([#1256](https://github.com/elefan-grenoble/gestion-compte/issues/1256)) ([6626096](https://github.com/elefan-grenoble/gestion-compte/commit/66260967dcf6cc12039035e835a52e039b28c6e4))
...
* **images:** Les images oubliées du passage à webpack. ([#1195](https://github.com/elefan-grenoble/gestion-compte/issues/1195)) ([987358a](https://github.com/elefan-grenoble/gestion-compte/commit/987358adad7bce8945d02f68d2a226057af16f5e))
...
* **makefile:** build the test schema from the migrations ([#1260](https://github.com/elefan-grenoble/gestion-compte/issues/1260)) ([8f5e5f6](https://github.com/elefan-grenoble/gestion-compte/commit/8f5e5f6ecf5e525d30457cd74d61e8ddbd37bd99))
...
* Pour avoir des variables ===null dans l'appli, il faut leur rajouter `default::` ([#1197](https://github.com/elefan-grenoble/gestion-compte/issues/1197)) ([919b933](https://github.com/elefan-grenoble/gestion-compte/commit/919b9336f594c2475929340926aaeca9c61121d9))
...
* **réservation de créneau:** Pouvoir déplier les quelques jours après la fin de cycle ([#1200](https://github.com/elefan-grenoble/gestion-compte/issues/1200)) ([9fca4cb](https://github.com/elefan-grenoble/gestion-compte/commit/9fca4cb698c161fbf5333591e25a42f638aa3af3))
...
* URLs dans les mails récurrents (cron) ([#1202](https://github.com/elefan-grenoble/gestion-compte/issues/1202)) ([93dbc49](https://github.com/elefan-grenoble/gestion-compte/commit/93dbc49119a3f63a1e9984ac6a585aa72dfe2dc3))
...
* Accélération de la page réservation de créneau ([#1191](https://github.com/elefan-grenoble/gestion-compte/issues/1191)) ([2dd592f](https://github.com/elefan-grenoble/gestion-compte/commit/2dd592f28e697be30c45149891976f3ed0ad5d8b))
* ajout d'une Github Action pour générer une liste des "top issues" ([#1114](https://github.com/elefan-grenoble/gestion-compte/issues/1114)) ([5225d82](https://github.com/elefan-grenoble/gestion-compte/commit/5225d822ae1510c912ea92d5f03e13059805e413))
...
* improve and fix test suite for Symfony 4 ([#1204](https://github.com/elefan-grenoble/gestion-compte/issues/1204)) ([#1205](https://github.com/elefan-grenoble/gestion-compte/issues/1205)) ([bb68c4f](https://github.com/elefan-grenoble/gestion-compte/commit/bb68c4f42c17206c2790ddd7d0d20403a0e761f1))
* installation de php-cs-fixer ([#1187](https://github.com/elefan-grenoble/gestion-compte/issues/1187)) ([ce7b91c](https://github.com/elefan-grenoble/gestion-compte/commit/ce7b91c9d5991833a169f6549d19c8167bca1543))


### Documentation

* Added link to new test guide in README.md ([#1215](https://github.com/elefan-grenoble/gestion-compte/issues/1215)) ([4a35bb7](https://github.com/elefan-grenoble/gestion-compte/commit/4a35bb798c1bc492b4aae6232f5ce8e2731b3b57))
* **audit:** technical audit — documentation, functional specs, prioritized TODO ([#1234](https://github.com/elefan-grenoble/gestion-compte/issues/1234)) ([3e9098b](https://github.com/elefan-grenoble/gestion-compte/commit/3e9098beb6200c24e7abd1e203af757bfcb5eafc))
